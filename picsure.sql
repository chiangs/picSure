...
INSERT INTO `address` VALUES (1,'1701 Wynkoop',NULL,'Denver','CO',80202,'USA',39.7531224,-105.0001446),(2,'1935 North Logan St','Ph 1','Denver','CO',80203,'USA',39.74691,-104.982303),(3,'4380 S. Monaco St','Unit 2105','Denver','CO',80237,'USA',39.634528,-104.911013),(4,'431 S. Fairfax Ave',NULL,'Los Angeles','Ca',90036,'USA',34.0689,-118.3618),(5,'1225 Eye St. NW',NULL,'Washington','DC',20005,'USA',38.9016,-77.029126);
...
CREATE TABLE `cartitem` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_cartItems_cart1_idx` (`cartId`),
  KEY `fk_cartItems_inventoryItem1_idx` (`inventoryItemId`),
  CONSTRAINT `fk_cartItems_cart1` FOREIGN KEY (`cartId`) REFERENCES `cart` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_cartItems_inventoryItem1` FOREIGN KEY (`inventoryItemId`) REFERENCES `inventoryitem` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `cartitem` VALUES (1,1,1,'2017-05-02 13:20:00','2017-05-02 14:18:16'),(2,1,41,'2017-05-02 13:20:00','2017-05-02 14:18:16');
...
CREATE TABLE `inventory` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_inventory_store1_idx` (`storeId`),
  CONSTRAINT `fk_inventory_store1` FOREIGN KEY (`storeId`) REFERENCES `store` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `inventoryitem` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_inventoryItem_equpiment1_idx` (`equipmentId`),
  KEY `fk_inventoryItem_inventory1_idx` (`inventoryId`),
  CONSTRAINT `fk_inventoryItem_equpiment1` FOREIGN KEY (`equipmentId`) REFERENCES `equipment` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_inventoryItem_inventory1` FOREIGN KEY (`inventoryId`) REFERENCES `inventory` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `inventoryitem` VALUES (1,1,1,1),(2,2,1,1),(3,3,1,1),(4,4,1,1),(5,5,1,1),(6,6,1,1),(7,7,1,1),(8,8,1,1),(9,9,1,1),(10,10,1,1),(11,11,1,1),(12,12,1,1),(13,13,1,1),(14,14,1,1),(15,15,1,1),(16,16,1,1),(17,17,1,1),(18,18,1,1),(19,19,1,1),(20,20,1,1),(21,21,1,1),(22,22,1,1),(23,23,1,1),(24,24,1,1),(25,25,1,1),(26,26,1,1),(27,27,1,1),(28,28,1,1),(29,29,1,1),(30,30,1,1),(31,31,1,1),(32,32,1,1),(33,33,1,1),(34,34,1,1),(35,35,1,1),(36,36,1,1),(37,37,1,1),(38,38,1,1),(39,39,1,1),(40,40,1,1),(41,41,1,1),(42,42,1,1),(43,43,1,1),(44,44,1,1),(45,45,1,1),(46,46,1,1),(47,47,1,1),(48,48,1,1),(49,49,1,1),(50,50,1,1),(51,51,1,1),(52,52,1,1),(53,53,1,1),(54,54,1,1),(55,55,1,1),(56,56,1,1),(57,57,1,1),(58,4,1,1),(59,7,1,1),(60,12,1,1),(61,15,1,1);
...
CREATE TABLE `lister` (
  ...
  KEY `fk_lister_store1_idx` (`storeId`),
  CONSTRAINT `fk_lister_store1` FOREIGN KEY (`storeId`) REFERENCES `store` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
INSERT INTO `lister` VALUES (1,1,1);
...
CREATE TABLE `reservation` (
  ...
  CONSTRAINT `fk_reservation_store1` FOREIGN KEY (`store_id`) REFERENCES `store` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
INSERT INTO `reservation` VALUES (1,2,'2017-05-02 12:20:00',1);
...
CREATE TABLE `reservationitem` (
  ...
  `timeIn` datetime NOT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_reservationItems_inventoryItem1_idx` (`inventoryItemId`),
  KEY `fk_reservationItems_reservation1_idx` (`reservationId`),
  CONSTRAINT `fk_reservationItems_inventoryItem1` FOREIGN KEY (`inventoryItemId`) REFERENCES `inventoryitem` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_reservationItems_reservation1` FOREIGN KEY (`reservationId`) REFERENCES `reservation` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `reservationitem`
--

LOCK TABLES `reservationitem` WRITE;
/*!40000 ALTER TABLE `reservationitem` DISABLE KEYS */;
INSERT INTO `reservationitem` VALUES (1,1,1,'2017-05-02 13:20:00','2017-05-02 14:18:16'),(2,41,1,'2017-05-02 13:20:00','2017-05-02 14:18:16');
/*!40000 ALTER TABLE `reservationitem` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `store` (
  ...
  KEY `fk_store_address1_idx` (`addressId`),
  CONSTRAINT `fk_store_address1` FOREIGN KEY (`addressId`) REFERENCES `address` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `store` VALUES (1,'UPic','303-555-01','BigRob@ilovecameras.com',1,1),(2,'Samys Camera','323-938-44','rentals@samys.com',4,1),(3,'District Camera and Imaging','202-483-00','sales@dc.districtcamera.com',5,1);
...
INSERT INTO `user` VALUES (1,'Seth','Thomas','admin','p','555-555-5555','swthomas@gmail.com',1),(2,'Daniel','Balarezo','danrezo','password','305-484-8911','drezo@me.com',0);
...
-- Dump completed on 2017-05-08 11:55:59
