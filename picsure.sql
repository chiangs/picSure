...
INSERT INTO `equipment` (`id`, `make`, `model`, `type`, `description`, `image`, `rate`) VALUES (27, 'Olympus', 'OMD E-M10', 'Mirrorless', 'You don’t have to choose between powerful and portable. The OM-D E-M10 gives you pro-style performance in a camera you can actually carry. Its thoughtful design centers on a solid, premium build that feels substantial in your hands, while its ergonomic shape and nimble control scheme allow you to focus on getting the perfect shot. The E-M10 also boasts a powerful TruePic™ VII image processor, interactive EVF, warp-speed AF system, built-in flash and WiFi, and a slew of creative tools.', '', 32);
INSERT INTO `equipment` (`id`, `make`, `model`, `type`, `description`, `image`, `rate`) VALUES (28, 'Panasonic', 'Lumix GH4', 'Mirrorless', 'The Panasonic LUMIX DMC-GH4 continues to evolve delivering professional quality video. Take advantage of 4K (Cinema 4K: 4096x2160 / 24 fps and QFHD 4K: 3840x2160 / up to 30 fps) video recording in MOV/MP4, or ultra high bitrate video recording at 200 Mbps (ALL-Intra) or 100 Mbps (IPB) without a recording time limit.*1 *2 Discover a variety of high-end functions for professional video recording.', '', 60);
INSERT INTO `equipment` (`id`, `make`, `model`, `type`, `description`, `image`, `rate`) VALUES (29, 'GoPro', 'Hero5', 'Action Camera', 'HERO5 Session combines 4K video, one-button simplicity and voice control all in a small, waterproof design.', '', 40);
...
INSERT INTO `equipment` (`id`, `make`, `model`, `type`, `description`, `image`, `rate`) VALUES (32, 'DJI', 'Mavic PRO', 'Drone', 'Portable yet powerful, the Mavic Pro is your personal drone, ready to go with you everywhere.', '', 115);
...
INSERT INTO `equipment` (`id`, `make`, `model`, `type`, `description`, `image`, `rate`) VALUES (46, 'Nikkor', 'AF-S 18-140mm f/3.5-5.6 G VR DX', 'Lens', 'If you\'re looking for an outstanding grab-and-go lens-the kind you\'ll keep on your camera for nearly every situation-check out the new Nikon AF-S DX NIKKOR 18-140mm f/3.5-5.6G ED VR Lens. Optimized to draw full potential from Nikons high-resolution DX-format image sensors, it delivers beautiful ultra-sharp photos and videos with softly blurred backgrounds. ', '', 15);
INSERT INTO `equipment` (`id`, `make`, `model`, `type`, `description`, `image`, `rate`) VALUES (47, 'Nikkor', 'AF-S 18-200mm f/3.5-5.6 G VRII DX', 'Lens', 'New ultra-high ratio zoom lens AF-S DX NIKKOR 18-200mm f/3.5-5.6G ED VR II for use expressly with Nikon DX-format digital-SLR cameras.Dimensions (DxL) Approx. 3.0 x 3.8\" (7.62 x 9.65 cm).', '', 15);
...
INSERT INTO `equipment` (`id`, `make`, `model`, `type`, `description`, `image`, `rate`) VALUES (49, 'Nikkor', 'AF-S 50mm f/1.8 G', 'Lens', 'Nikon AF-S Nikkor 50mm f/1.8G Lens, 58mm Snap-On Lens Cap, LF-4 Rear Lens Cap, HB-47 Bayonet Lens Hood for AF-S 50mm f/1.4G', '', 12);
INSERT INTO `equipment` (`id`, `make`, `model`, `type`, `description`, `image`, `rate`) VALUES (50, 'Nikkor', 'AF-S 24-70mm f/2.8 G ED', 'Lens', 'The classic standard zoom now featuring Vibration Reduction image stabilization, Nikon\'s AF-S NIKKOR 24-70mm f/2.8E ED VR Lens is a truly versatile wide-angle to short telephoto lens characterized by its constant f/2.8 maximum aperture and electromagnetic aperture mechanism', '', 15);
INSERT INTO `equipment` (`id`, `make`, `model`, `type`, `description`, `image`, `rate`) VALUES (51, 'Sony', 'FE 35mm f/2.8 ZA', 'Lens', 'The small size, versatile 35mm focal length, and outstanding overall performance of this Carl Zeiss Sonnar T* lens make it an ideal match for compact 35mm full frame format E-mount bodies. ', '', 15);
INSERT INTO `equipment` (`id`, `make`, `model`, `type`, `description`, `image`, `rate`) VALUES (52, 'Sony', 'FE 55mm f/1.8 ZA', 'Lens', 'A bright lens like this is also an advantage when shooting indoors or outdoors in low light. Linear motor driven internal focusing is smooth and quiet, and a dust and moisture resistant design ensures consistently reliable performance.', '', 15);
...
INSERT INTO `equipment` (`id`, `make`, `model`, `type`, `description`, `image`, `rate`) VALUES (54, 'Sony', 'FE 24-70mm f/2.8 GM', 'Lens', 'The Sony FE 24-70mm F2.8 GM Zoom Lens is the ultimate choice for those seeking the highest possible optical performance for portrait, travel and event photography or even simple everyday shooting.', '', 15);
INSERT INTO `equipment` (`id`, `make`, `model`, `type`, `description`, `image`, `rate`) VALUES (55, 'Sony', 'FE 28-70mm f/3.5-5.6 OSS', 'Lens', 'The Sony FE 28-70mm f/3.5-5.6 OSS Lens is a versatile, compact, and lightweight wide-angle to portrait-length zoom lens designed specifically for full-frame E-mount cameras. ', '', 20);
INSERT INTO `equipment` (`id`, `make`, `model`, `type`, `description`, `image`, `rate`) VALUES (56, 'Sony', 'FE 70-200mm f/4 G OSS', 'Lens', 'The small size, versatile 35mm focal length, and outstanding overall performance of this Carl Zeiss Sonnar T* lens make it an ideal match for compact 35mm full frame format E-mount bodies. ', '', 15);
INSERT INTO `equipment` (`id`, `make`, `model`, `type`, `description`, `image`, `rate`) VALUES (57, 'Panasonic', 'Lumix G X Vario 35-100mm f/2.8 ASPH', 'Lens', 'The Panasonic LUMIX G X VARIO camera lens represents the next natural step in design and build for digital interchangeable zoom lenses. A first for the LUMIX G Series, the G VARIO constant with F2.8 zoom is suitable for professionals and enthusiasts alike.', '', 15);
INSERT INTO `equipment` (`id`, `make`, `model`, `type`, `description`, `image`, `rate`) VALUES (58, 'Panasonic', 'Lumix G Leica DG Nocticron 42.5mm f/1.2', 'Lens', 'The LUMIX G Leica DG Nocticron 42.5mm f/1.2 ASPH Power OIS Lens from Panasonic offers a 35mm focal length equivalent of 85mm and a fast aperture of f/1.2 making it well-suited for portraits. ', '', 20);
...
INSERT INTO `inventoryItem` (`id`, `equipmentId`, `inventoryId`, `active`, `rentalRate`) VALUES (58, 4, 1, 1, 15);
INSERT INTO `inventoryItem` (`id`, `equipmentId`, `inventoryId`, `active`, `rentalRate`) VALUES (59, 7, 1, 1, 20);
INSERT INTO `inventoryItem` (`id`, `equipmentId`, `inventoryId`, `active`, `rentalRate`) VALUES (60, 12, 1, 1, 12);
INSERT INTO `inventoryItem` (`id`, `equipmentId`, `inventoryId`, `active`, `rentalRate`) VALUES (61, 15, 1, 1, 15);
INSERT INTO `inventoryItem` (`id`, `equipmentId`, `inventoryId`, `active`, `rentalRate`) VALUES (62, 33, 2, 1, 5);
INSERT INTO `inventoryItem` (`id`, `equipmentId`, `inventoryId`, `active`, `rentalRate`) VALUES (63, 12, 2, 1, 5);
INSERT INTO `inventoryItem` (`id`, `equipmentId`, `inventoryId`, `active`, `rentalRate`) VALUES (64, 14, 2, 1, 5);
INSERT INTO `inventoryItem` (`id`, `equipmentId`, `inventoryId`, `active`, `rentalRate`) VALUES (65, 18, 2, 1, 5);
INSERT INTO `inventoryItem` (`id`, `equipmentId`, `inventoryId`, `active`, `rentalRate`) VALUES (66, 1, 2, 1, 5);
INSERT INTO `inventoryItem` (`id`, `equipmentId`, `inventoryId`, `active`, `rentalRate`) VALUES (67, 2, 2, 1, 5);
INSERT INTO `inventoryItem` (`id`, `equipmentId`, `inventoryId`, `active`, `rentalRate`) VALUES (68, 3, 2, 1, 5);
INSERT INTO `inventoryItem` (`id`, `equipmentId`, `inventoryId`, `active`, `rentalRate`) VALUES (69, 4, 2, 1, 5);
INSERT INTO `inventoryItem` (`id`, `equipmentId`, `inventoryId`, `active`, `rentalRate`) VALUES (70, 5, 2, 1, 5);
INSERT INTO `inventoryItem` (`id`, `equipmentId`, `inventoryId`, `active`, `rentalRate`) VALUES (71, 6, 2, 1, 5);
INSERT INTO `inventoryItem` (`id`, `equipmentId`, `inventoryId`, `active`, `rentalRate`) VALUES (72, 7, 2, 1, 5);
INSERT INTO `inventoryItem` (`id`, `equipmentId`, `inventoryId`, `active`, `rentalRate`) VALUES (73, 12, 3, 1, 5);
INSERT INTO `inventoryItem` (`id`, `equipmentId`, `inventoryId`, `active`, `rentalRate`) VALUES (74, 13, 3, 1, 5);
INSERT INTO `inventoryItem` (`id`, `equipmentId`, `inventoryId`, `active`, `rentalRate`) VALUES (75, 14, 3, 1, 5);
INSERT INTO `inventoryItem` (`id`, `equipmentId`, `inventoryId`, `active`, `rentalRate`) VALUES (76, 15, 3, 1, 5);
INSERT INTO `inventoryItem` (`id`, `equipmentId`, `inventoryId`, `active`, `rentalRate`) VALUES (77, 16, 3, 1, 5);
INSERT INTO `inventoryItem` (`id`, `equipmentId`, `inventoryId`, `active`, `rentalRate`) VALUES (78, 51, 3, 1, 5);
INSERT INTO `inventoryItem` (`id`, `equipmentId`, `inventoryId`, `active`, `rentalRate`) VALUES (79, 53, 3, 1, 5);
INSERT INTO `inventoryItem` (`id`, `equipmentId`, `inventoryId`, `active`, `rentalRate`) VALUES (80, 56, 3, 1, 5);
INSERT INTO `inventoryItem` (`id`, `equipmentId`, `inventoryId`, `active`, `rentalRate`) VALUES (81, 21, 3, 1, 5);
INSERT INTO `inventoryItem` (`id`, `equipmentId`, `inventoryId`, `active`, `rentalRate`) VALUES (82, 22, 3, 1, 5);
INSERT INTO `inventoryItem` (`id`, `equipmentId`, `inventoryId`, `active`, `rentalRate`) VALUES (83, 23, 3, 1, 5);
INSERT INTO `inventoryItem` (`id`, `equipmentId`, `inventoryId`, `active`, `rentalRate`) VALUES (84, 35, 3, 1, 5);
INSERT INTO `inventoryItem` (`id`, `equipmentId`, `inventoryId`, `active`, `rentalRate`) VALUES (85, 2, 3, 1, 5);
INSERT INTO `inventoryItem` (`id`, `equipmentId`, `inventoryId`, `active`, `rentalRate`) VALUES (86, 1, 3, 1, 5);
INSERT INTO `inventoryItem` (`id`, `equipmentId`, `inventoryId`, `active`, `rentalRate`) VALUES (87, 3, 3, 1, 5);
INSERT INTO `inventoryItem` (`id`, `equipmentId`, `inventoryId`, `active`, `rentalRate`) VALUES (88, 32, 3, 1, 5);
INSERT INTO `inventoryItem` (`id`, `equipmentId`, `inventoryId`, `active`, `rentalRate`) VALUES (89, 16, 4, 1, 5);
INSERT INTO `inventoryItem` (`id`, `equipmentId`, `inventoryId`, `active`, `rentalRate`) VALUES (90, 18, 4, 1, 5);
INSERT INTO `inventoryItem` (`id`, `equipmentId`, `inventoryId`, `active`, `rentalRate`) VALUES (91, 19, 4, 1, 5);
INSERT INTO `inventoryItem` (`id`, `equipmentId`, `inventoryId`, `active`, `rentalRate`) VALUES (92, 20, 4, 1, 5);
INSERT INTO `inventoryItem` (`id`, `equipmentId`, `inventoryId`, `active`, `rentalRate`) VALUES (93, 21, 4, 1, 5);
INSERT INTO `inventoryItem` (`id`, `equipmentId`, `inventoryId`, `active`, `rentalRate`) VALUES (94, 5, 5, 1, 5);
INSERT INTO `inventoryItem` (`id`, `equipmentId`, `inventoryId`, `active`, `rentalRate`) VALUES (95, 6, 5, 1, 5);
INSERT INTO `inventoryItem` (`id`, `equipmentId`, `inventoryId`, `active`, `rentalRate`) VALUES (96, 7, 5, 1, 5);
INSERT INTO `inventoryItem` (`id`, `equipmentId`, `inventoryId`, `active`, `rentalRate`) VALUES (97, 21, 6, 1, 5);
INSERT INTO `inventoryItem` (`id`, `equipmentId`, `inventoryId`, `active`, `rentalRate`) VALUES (98, 1, 6, 1, 5);
INSERT INTO `inventoryItem` (`id`, `equipmentId`, `inventoryId`, `active`, `rentalRate`) VALUES (99, 2, 6, 1, 5);
INSERT INTO `inventoryItem` (`id`, `equipmentId`, `inventoryId`, `active`, `rentalRate`) VALUES (100, 3, 6, 1, 5);
INSERT INTO `inventoryItem` (`id`, `equipmentId`, `inventoryId`, `active`, `rentalRate`) VALUES (101, 4, 6, 1, 5);
INSERT INTO `inventoryItem` (`id`, `equipmentId`, `inventoryId`, `active`, `rentalRate`) VALUES (102, 5, 6, 1, 5);
INSERT INTO `inventoryItem` (`id`, `equipmentId`, `inventoryId`, `active`, `rentalRate`) VALUES (103, 6, 6, 1, 5);
INSERT INTO `inventoryItem` (`id`, `equipmentId`, `inventoryId`, `active`, `rentalRate`) VALUES (104, 7, 6, 1, 5);
INSERT INTO `inventoryItem` (`id`, `equipmentId`, `inventoryId`, `active`, `rentalRate`) VALUES (105, 8, 6, 1, 5);
INSERT INTO `inventoryItem` (`id`, `equipmentId`, `inventoryId`, `active`, `rentalRate`) VALUES (106, 9, 6, 1, 5);
INSERT INTO `inventoryItem` (`id`, `equipmentId`, `inventoryId`, `active`, `rentalRate`) VALUES (107, 10, 6, 1, 5);
INSERT INTO `inventoryItem` (`id`, `equipmentId`, `inventoryId`, `active`, `rentalRate`) VALUES (108, 11, 6, 1, 5);
